...
<!-- <div class="heading_container">
    <div class="back_button"><a href="./photo_gallery.php" style="text-decoration:none;color:white;">HOME</a></div>
    ...
    <div class="home_button">BACK</div>
       ...
       <div class="button" >
		<a href="../Photo Gallery/photo_gallery.php">Home</a>
            ...
            <?php
            $dir = glob('inside/sports/{*.jpg,*.jpeg,*.png,*.JPG}',GLOB_BRACE);
            foreach($dir as $value){

              ?>
              <div class="thumbnails">

              <a href="<?php echo $value; ?>" data-fancybox="inside/sports" data-caption="<?php echo $value; ?>">
